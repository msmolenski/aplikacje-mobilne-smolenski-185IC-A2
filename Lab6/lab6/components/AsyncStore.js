    ...
    <View style={{ flex: 1, marginTop: 50 }}>
      ...
      <View>
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <TextInput onEndEditing={event =>{this.setState({setKey: event.nativeEvent.text})} } placeholder="Klucz"  style={styles.pages.input}/>
                            </View>
                            <Text style={styles.pages.text}>Podaj Wartość</Text>
                            <View style={{flexDirection: 'row'}}>
                                <TextInput onEndEditing={event =>{this.setState({setValue: event.nativeEvent.text})}} placeholder="Wartość"  style={styles.pages.input}/>
                            </View>
                            <Button
                                title='Dodaj wartość'
                            ...
                            <View style={{flexDirection: 'row'}}>
                                <TextInput onEndEditing={event =>{this.setState({getKey: event.nativeEvent.text})}} placeholder="Klucz"  style={styles.pages.input}/>
                            </View>
                            <Button
